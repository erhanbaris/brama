...
MunitResult keyword_operator(const MunitParameter params[], void* user_data_or_fixture) {
    ...
    OPERATOR_CHECK(4,  OPERATOR_MODULES);
    ...
    OPERATOR_CHECK(25, OPERATOR_BITWISE_RIGHT_SHIFT);
    OPERATOR_CHECK(26, OPERATOR_GREATER_THAN);
    OPERATOR_CHECK(27, OPERATOR_LESS_THAN);
    OPERATOR_CHECK(28, OPERATOR_GREATER_EQUAL_THAN);
    OPERATOR_CHECK(29, OPERATOR_LESS_EQUAL_THAN);
    OPERATOR_CHECK(30, OPERATOR_QUESTION_MARK);
    OPERATOR_CHECK(31, OPERATOR_COLON_MARK);
    OPERATOR_CHECK(32, OPERATOR_BITWISE_AND_ASSIGN);
    OPERATOR_CHECK(33, OPERATOR_BITWISE_OR_ASSIGN);
    OPERATOR_CHECK(34, OPERATOR_BITWISE_XOR_ASSIGN);
    OPERATOR_CHECK(35, OPERATOR_LEFT_PARENTHESES);
    OPERATOR_CHECK(36, OPERATOR_RIGHT_PARENTHESES);
    OPERATOR_CHECK(37, OPERATOR_SQUARE_BRACKET_START);
    OPERATOR_CHECK(38, OPERATOR_SQUARE_BRACKET_END);
