...
MunitResult ast_primary_expr_test_1(const MunitParameter params[], void* user_data_or_fixture) {
    ...
    ast = NULL;
    munit_assert_int(ast_declaration_stmt(context, &ast, NULL), ==, BRAMA_DOES_NOT_MATCH_AST);
    destroy_ast(ast);
    BRAMA_FREE(ast);
...
MunitResult ast_primary_expr_test_6(const MunitParameter params[], void* user_data_or_fixture) {
    ...
    t_ast_ptr ast = NULL;
    munit_assert_int(ast_declaration_stmt(context, &ast, NULL),  ==, BRAMA_SEMICOLON_REQUIRED);
    brama_destroy(context);
    return MUNIT_OK;
}
...
MunitResult ast_primary_expr_test_7(const MunitParameter params[], void* user_data_or_fixture) {
    ...
    t_ast_ptr ast = NULL;
    munit_assert_int(ast_declaration_stmt(context, &ast, NULL),  ==, BRAMA_DICTIONARY_NOT_VALID);
    brama_destroy(context);
    return MUNIT_OK;
}
...
MunitResult ast_primary_expr_test_11(const MunitParameter params[], void* user_data_or_fixture) {
    ...
    t_ast_ptr ast = NULL;
    munit_assert_int(ast_declaration_stmt(context, &ast, NULL),  ==, BRAMA_ARRAY_NOT_VALID);
    brama_destroy(context);
    return MUNIT_OK;
}
...
MunitResult ast_unary_expr_test_6(const MunitParameter params[], void* user_data_or_fixture) {
    ...
    t_ast_ptr ast = NULL;
    munit_assert_int(ast_declaration_stmt(context, &ast, NULL), == , BRAMA_INVALID_UNARY_EXPRESSION);
...
MunitResult ast_func_decl_test_2(const MunitParameter params[], void* user_data_or_fixture) {
    ...
    t_ast_ptr ast = NULL;
    munit_assert_int         (ast_declaration_stmt(context, &ast, NULL), == , BRAMA_ILLEGAL_FUNCTION_ARGUMENT);
    brama_destroy(context);
    return MUNIT_OK;
}
